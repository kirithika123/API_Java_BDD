...
public class SkillMaster {
   ...
   /**
	...
	/*@Then("check the Database for skills from {string} sheet and {int} row")
	public void check_the_database_for_all_skills(String SheetName, int RowNumber) throws InvalidFormatException, IOException {
		    ExcelReader reader = new ExcelReader();
		    List<Map<String, String>> DeltestData = reader.getData(this.lmsPojo.getExcelPath(), SheetName);
		    String getStr_Query="select skill_id,skill_name from tbl_lms_skill_master WHERE user_skill_id='"
